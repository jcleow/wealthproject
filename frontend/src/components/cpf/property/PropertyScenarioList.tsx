  ...
  return (
    ...
    >
      <div className="flex items-start gap-3">
        ...
        {/* Content - Grid with name and grouped badges */}
        <div className="flex-1 min-w-0 grid grid-cols-[1fr_auto] gap-x-3 gap-y-1 items-center">
          {/* Row 1: Name + Badges (grouped) */}
