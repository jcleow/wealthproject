...
/**
 * Insurance policy config with personIndex for linking
 */
export interface InsurancePolicyConfig extends Omit<InsurancePolicyCreateInput, 'personId'> {
  personIndex: number
}
...
export interface ProfileData {
  ...
  insurancePolicies?: InsurancePolicyConfig[]
    ...
    insurancePolicies: [
      {
        ...
        endDate: getDateOfBirth(-30), // 30 years from base date
        insurerName: 'NTUC Income',
        policyNumber: 'TL2026-0011',
        isActive: true,
        notes: JSON.stringify({ userNotes: 'Basic term life coverage, affordable for fresh grad.' }),
      },
      {
        personIndex: 0,
        ...
        startDate: todayIso.split('T')[0],
        insurerName: 'AIA',
        policyNumber: 'H2026-0022',
        isActive: true,
        notes: JSON.stringify({ wardClass: 'B1', ispRider: true, userNotes: 'ISP upgrade from MediShield Life. Ward B1 coverage.' }),
      },
    ],
    scenarioEvents: [
      {
  ...
  return {
    ...
    insurancePolicies: [
      // Partner 1 - Software Engineer
      {
        ...
        deathBenefit: '300000',
        tpdBenefit: '300000',
        criticalIllnessBenefit: '75000',
        premiumAmount: '220',
        premiumFrequency: 'monthly',
        startDate: todayIso.split('T')[0],
        insurerName: 'AIA',
        policyNumber: 'L2024-3301',
        isActive: true,
        notes: JSON.stringify({ userNotes: 'Whole life with CI rider. Covers BTO mortgage balance.' }),
      },
      {
        personIndex: 0,
        ...
        policyNumber: 'H2024-4401',
        isActive: true,
        notes: JSON.stringify({ wardClass: 'A', ispRider: true, userNotes: 'Private ward coverage with rider.' }),
      },
      // Partner 2 - Finance Analyst
      {
        personIndex: 1,
        name: 'Great Eastern GREAT Term',
        category: 'life',
        subcategory: 'term_life',
        ...
        premiumFrequency: 'monthly',
        startDate: todayIso.split('T')[0],
        endDate: getDateOfBirth(-25), // until ~55 years old
        insurerName: 'Great Eastern',
        policyNumber: 'TL2024-5501',
        isActive: true,
        notes: JSON.stringify({ userNotes: 'Term life until mortgage is paid off.' }),
      },
      {
        personIndex: 1,
        name: 'AIA HealthShield Gold Max',
        ...
        startDate: todayIso.split('T')[0],
        insurerName: 'AIA',
        policyNumber: 'H2024-6601',
        isActive: true,
        notes: JSON.stringify({ wardClass: 'A', ispRider: true, userNotes: 'Upgraded from MediShield Life.' }),
      },
    ],
    scenarioEvents: [
      {
...
export function generateDinkKidsPlannedProfile(): ProfileData {
  return {
    ...
    insurancePolicies: [
      // Alex - Software Engineer, primary earner
      {
        personIndex: 0,
        name: 'AIA Pro Lifetime Protector',
        category: 'life',
        ...
        isActive: true,
        notes: JSON.stringify({ userNotes: 'Covers mortgage + 5 years expenses. CI rider included.' }),
      },
      {
        personIndex: 0,
        name: 'Prudential PRUShield Plus',
        ...
        isActive: true,
        notes: JSON.stringify({ wardClass: 'A', ispRider: true, deductible: '$1,500', userNotes: 'Private ward class with rider.' }),
      },
      {
        personIndex: 0,
        name: 'AIA CI Secure',
        ...
        isActive: true,
        notes: JSON.stringify({ userNotes: 'Late-stage CI. Covers 2-3 years income replacement.' }),
      },
      // Sarah - Marketing Manager
      {
        ...
        premiumFrequency: 'monthly',
        startDate: todayIso.split('T')[0],
        endDate: getDateOfBirth(-25),
        insurerName: 'Great Eastern',
        policyNumber: 'TL9012-6678',
        isActive: true,
        notes: JSON.stringify({ userNotes: 'Term life until children finish university.' }),
      },
      {
        personIndex: 1,
        name: 'AIA HealthShield Gold Max',
        ...
        isActive: true,
        notes: JSON.stringify({ wardClass: 'A', ispRider: true, userNotes: 'Full private hospital coverage.' }),
      },
      {
        personIndex: 1,
        ...
        isActive: true,
        notes: JSON.stringify({ earlyCiCoverage: true, userNotes: 'Early CI plan for income gap during treatment.' }),
      },
    ],
    scenarioEvents: [
      {
...
export function generateSingleIncomeFamilyProfile(): ProfileData {
  return {
    ...
    insurancePolicies: [
      // Working Parent - sole earner, needs strong protection
      {
        personIndex: 0,
        ...
        startDate: todayIso.split('T')[0],
        insurerName: 'Prudential',
        policyNumber: 'L2020-7701',
        isActive: true,
        notes: JSON.stringify({ userNotes: 'Sole earner protection. Covers HDB loan + 5 years family expenses.' }),
      },
      {
        personIndex: 0,
        name: 'AIA HealthShield Gold Max',
        ...
        startDate: todayIso.split('T')[0],
        insurerName: 'AIA',
        policyNumber: 'H2020-8801',
        isActive: true,
        notes: JSON.stringify({ wardClass: 'A', ispRider: true, userNotes: 'Private ward. Cannot afford downtime as sole earner.' }),
      },
      {
        personIndex: 0,
        name: 'Great Eastern CI Supreme',
        category: 'critical_illness',
        subcategory: 'late_ci',
        coverageAmount: '250000',
        criticalIllnessBenefit: '250000',
        premiumAmount: '180',
        premiumFrequency: 'monthly',
        startDate: todayIso.split('T')[0],
        insurerName: 'Great Eastern',
        policyNumber: 'CI2020-9901',
        isActive: true,
        notes: JSON.stringify({ userNotes: 'CI coverage = 3 years income replacement for family.' }),
      },
      // Stay-home Parent
      {
        personIndex: 1,
        name: 'NTUC Income Term Life Plus',
        category: 'life',
        subcategory: 'term_life',
        coverageAmount: '200000',
        deathBenefit: '200000',
        ...
        premiumFrequency: 'monthly',
        startDate: todayIso.split('T')[0],
        endDate: getDateOfBirth(-18),
        insurerName: 'NTUC Income',
        policyNumber: 'TL2021-1101',
        isActive: true,
        notes: JSON.stringify({ userNotes: 'Term life for stay-home parent. Covers childcare cost if unable to care for kids.' }),
      },
      {
        personIndex: 1,
        name: 'Prudential PRUShield Standard',
        category: 'hospitalization',
        subcategory: 'isp',
        coverageAmount: '500000',
        premiumAmount: '25',
        ...
        startDate: todayIso.split('T')[0],
        insurerName: 'Prudential',
        policyNumber: 'H2021-2201',
        isActive: true,
        notes: JSON.stringify({ wardClass: 'B1', ispRider: true, userNotes: 'Ward B1 coverage. Budget-conscious choice.' }),
      },
    ],
    scenarioEvents: [
      {
...
export function generateFireFocusedProfile(): ProfileData {
  return {
    ...
    insurancePolicies: [
      // FIRE-focused: lean insurance, term-only, no whole life (prefers to invest the difference)
      {
        personIndex: 0,
        name: 'FWD Term Life Plus',
        category: 'life',
        subcategory: 'term_life',
        coverageAmount: '500000',
        deathBenefit: '500000',
        ...
        premiumFrequency: 'monthly',
        startDate: todayIso.split('T')[0],
        endDate: getDateOfBirth(-20), // until ~55, covers pre-FIRE years
        insurerName: 'FWD',
        policyNumber: 'TL2023-1101',
        isActive: true,
        notes: JSON.stringify({ userNotes: 'Term life only — invest the difference. Drops off after FIRE target hit.' }),
      },
      {
        personIndex: 0,
        name: 'AIA HealthShield Gold Max',
        ...
        startDate: todayIso.split('T')[0],
        insurerName: 'AIA',
        policyNumber: 'H2023-2201',
        isActive: true,
        notes: JSON.stringify({ wardClass: 'A', ispRider: true, userNotes: 'Non-negotiable even for FIRE. Medical bankruptcy is the #1 risk.' }),
      },
      {
        personIndex: 0,
        name: 'NTUC Income CI Protector',
        category: 'critical_illness',
        subcategory: 'early_ci',
        ...
        startDate: todayIso.split('T')[0],
        insurerName: 'NTUC Income',
        policyNumber: 'CI2023-3301',
        isActive: true,
        notes: JSON.stringify({ earlyCiCoverage: true, userNotes: 'Modest CI coverage. Self-insured for the rest via portfolio.' }),
      },
    ],
    scenarioEvents: [
      {
