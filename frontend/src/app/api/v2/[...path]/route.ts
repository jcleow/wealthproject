...
/**
 * Proxies authenticated requests to the Go backend V2 endpoints.
...
async function proxyToBackend(
  ...
  console.log(`[BFF] ${request.method} /api/v2/${path}`)
  ...
  const backendUrl = `${BACKEND_URL}/api/v2/${path}${queryString}`
