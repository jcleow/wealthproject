...
Use this skill when planning new features, creating PRDs/tickets, or architecting implementations.
This contains comprehensive guidelines for code architecture, patterns, and reuse requirements.
