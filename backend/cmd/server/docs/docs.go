...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/v2/cash-accounts": {
            ...
            "delete": {
                ...
                "operationId": "deleteBulkCashAccounts",
                "responses": {
                    "204": {
                        "description": "No Content"
                    },
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/handlers.cpfAssumptionsResponse"
                        }
                    },
                    "404": {
                        "description": "Not Found",
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handlers.cpfAssumptionsInput"
                        }
                    }
                ],
                "responses": {
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handlers.cpfProjectionInput"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/handlers.cpfProjectionResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handlers.cpfBalanceProjectionProjectionInput"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/handlers.cpfBalanceProjectionProjectionResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/v2/cpf/accounts": {
            ...
            "delete": {
                ...
                "operationId": "deleteBulkCPFAccounts",
                "responses": {
                    "204": {
                        "description": "No Content"
                    },
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handlers.age55ConversionInput"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/handlers.age55ConversionResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handlers.cpfLifeEstimateInput"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/handlers.cpfLifeEstimateResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/handlers.cpfHousingUsageFullResponse"
                        }
                    },
                    "404": {
                        "description": "Not Found",
        ...
        "/v2/fund-flow-rules/{id}": {
            ...
            "delete": {
                ...
                "operationId": "deleteFundFlowRule",
                "parameters": [
                    {
                        "type": "string",
                        "description": "Rule ID",
        ...
        "/v2/investments": {
            ...
            "delete": {
                ...
                "operationId": "deleteBulkInvestments",
                "responses": {
                    "204": {
                        "description": "No Content"
                    },
        ...
        "/v2/liabilities": {
            ...
            "delete": {
                ...
                "operationId": "deleteBulkLiabilities",
                "responses": {
                    "204": {
                        "description": "No Content"
                    },
        ...
        "/v2/property-planner/scenarios": {
            ...
            "delete": {
                ...
                "operationId": "deleteBulkPropertyScenarios",
                "responses": {
                    "204": {
                        "description": "No Content"
                    },
        ...
        "/v2/property-planner/scenarios/{id}": {
            ...
            "delete": {
                ...
                "operationId": "deletePropertyScenario",
                "parameters": [
                    {
                        "type": "string",
                        "description": "Scenario ID",
    ...
    "definitions": {
        ...
        "handlers.age55ConversionResponse": {
            "type": "object",
            "properties": {
                "cpfLifeEligible": {
                    "type": "boolean"
        ...
        "handlers.cpfAccruedInterestSchedule": {
            "type": "object",
            "properties": {
                "asOfDate": {
                    "type": "string"
                ...
                "yearlyBreakdown": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/handlers.cpfYearlyAccrued"
                    }
                }
            }
        },
        "handlers.cpfAssumptionsInput": {
            "type": "object",
            "properties": {
                "cpfLife": {
                    "type": "object",
        ...
        "handlers.cpfAssumptionsResponse": {
            "type": "object",
            "properties": {
                "cpfAccountId": {
                    "type": "string"
        ...
        "handlers.cpfBalanceProjectionProjectionInput": {
            "type": "object",
            "properties": {
                "payoutStartAge": {
        ...
        "handlers.cpfBalanceProjectionProjectionResponse": {
            "type": "object",
            "properties": {
                "age55Balances": {
                    "type": "object",
                ...
                "snapshots": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/handlers.cpfBalanceProjectionSnapshotResponse"
                    }
                }
            }
        },
        "handlers.cpfBalanceProjectionSnapshotResponse": {
            "type": "object",
            "properties": {
                "age": {
                    "type": "integer"
        ...
        "handlers.cpfHousingMonthlyPayment": {
            "type": "object",
            "properties": {
                "cashUsed": {
                    "type": "string"
        ...
        "handlers.cpfHousingUsageDownPayment": {
            "type": "object",
            "properties": {
                "cashUsed": {
                    "type": "string"
        ...
        "handlers.cpfHousingUsageFullResponse": {
            "type": "object",
            "properties": {
                "saleAnalysis": {
                    "$ref": "#/definitions/handlers.cpfPropertySaleAnalysis"
                },
                "usage": {
                    "$ref": "#/definitions/handlers.cpfHousingUsageResponse"
                }
            }
        },
        "handlers.cpfHousingUsageResponse": {
            "type": "object",
            "properties": {
                "accruedInterest": {
                    "$ref": "#/definitions/handlers.cpfAccruedInterestSchedule"
                },
                "borrower1": {
                    "$ref": "#/definitions/handlers.cpfBorrowerUsage"
                },
                "borrower2": {
                    "$ref": "#/definitions/handlers.cpfBorrowerUsage"
                },
                "downPayment": {
                    "$ref": "#/definitions/handlers.cpfHousingUsageDownPayment"
                },
                "holdingMonths": {
                    "type": "integer"
                },
                "monthlyPayments": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/handlers.cpfHousingMonthlyPayment"
                    }
                },
                "propertyScenarioId": {
                    "type": "string"
                ...
                "totals": {
                    "$ref": "#/definitions/handlers.cpfHousingUsageTotals"
                }
            }
        },
        "handlers.cpfHousingUsageTotals": {
            "type": "object",
            "properties": {
                "oaForDownPayment": {
                    "type": "string"
        ...
        "handlers.cpfLifeEstimateResponse": {
            "type": "object",
            "properties": {
                "birthYear": {
                    "type": "integer"
        ...
        "handlers.cpfProjectionResponse": {
            "type": "object",
            "properties": {
                "age65Date": {
        ...
        "handlers.cpfPropertySaleAnalysis": {
            "type": "object",
            "properties": {
                "cpfRefundRequired": {
                    "type": "object",
